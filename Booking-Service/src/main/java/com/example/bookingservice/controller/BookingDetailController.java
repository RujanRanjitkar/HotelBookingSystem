...
public class BookingDetailController {
    ...
    public ResponseEntity<String> bookRooms(@RequestBody BookingDetailRequestDto bookingDetailRequestDto, @RequestHeader("Authorization") String authorizationHeader){
