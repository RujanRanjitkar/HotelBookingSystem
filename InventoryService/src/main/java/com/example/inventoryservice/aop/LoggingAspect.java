...
public class LoggingAspect {
    ...
    @Around(value = "within(com.example.inventoryservice.hotel.service.HotelServiceImpl) || within(com.example.inventoryservice.room.service.RoomServiceImpl)")
    ...
    @Pointcut("within(com.example.inventoryservice.hotel.service.*) || within(com.example.inventoryservice.room.service.*)")
