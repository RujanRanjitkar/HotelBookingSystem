...
public class RoomController {
    ...
    public ResponseEntity<String> updateRoomInfo(@PathVariable Long roomId, @RequestPart RoomRequestDto roomRequestDto, @RequestPart List<MultipartFile> roomImages) throws IOException {

        roomService.updateRoomInfo(roomId, roomRequestDto, path, roomImages);
